...
class MagikVSCode {
  ...
  _compileText(lines) {
    if (!this._terminal) {
      vscode.window.showWarningMessage('Open a Magik Session')
      return
    }
  ...
  _compileExtensionMagik() {
    ...
    const ext = vscode.extensions.getExtension('alexhenriquepv.vscodesw');
    if (ext) {
